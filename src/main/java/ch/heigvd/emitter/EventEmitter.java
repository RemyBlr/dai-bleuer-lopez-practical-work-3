            ...
            try (DatagramSocket socket = new DatagramSocket()) {
                ...
                while (true) {
                    ...
                    if (!isAuto) {
                        ...
                        event = new Event(eventName[(int) (Math.random() * eventName.length)], dates[(int) (Math.random() * dates.length)], cities[(int) (Math.random() * cities.length)], "une conférence sur le meilleur langage de programmation");
                    }
