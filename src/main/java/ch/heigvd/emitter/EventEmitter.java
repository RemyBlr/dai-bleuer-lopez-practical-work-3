...
public class EventEmitter implements Runnable{
    ...
    @CommandLine.Option(names = {"-p", "--port"}, description = "UDP port to listen on for unicast")
            ...
            try (DatagramSocket socket = new DatagramSocket()) {
                ...
                while (true) {
                    ...
                    if (!isAuto) {
                        ...
                        String[] dates = {"01.01.2021", "02.01.2021", "03.01.2021", "04.01.2021", "05.01.2021", "06.01.2021", "07.01.2021", "08.01.2021", "09.01.2021", "10.01.2021", "11.01.2021", "12.01.2021", "13.01.2021", "14.01.2021", "15.01.2021", "16.01.2021", "17.01.2021", "18.01.2021", "19.01.2021", "20.01.2021", "21.01.2021", "22.01.2021", "23.01.2021", "24.01.2021", "25.01.2021", "26.01.2021", "27.01.2021", "28.01.2021", "29.01.2021", "30.01.2021", "31.01.2021"};
                        String[] eventName={"Java Conference","C++ Conference","Python Conference","C# Conference","PHP Conference","HTML Conference","CSS Conference","JavaScript Conference","SQL Conference","Ruby Conference","Swift Conference","Kotlin Conference","R Conference","Go Conference","Scala Conference","Rust Conference","Perl Conference","Objective-C Conference","TypeScript Conference","Assembly Conference","Dart Conference","MATLAB Conference","Visual Basic Conference","Delphi Conference","PL/SQL Conference","Ada Conference","Lisp Conference","Fortran Conference","COBOL Conference","Logo Conference","Prolog Conference","Bash Conference","PowerShell Conference","Lua Conference","Scratch Conference","ABAP Conference","Erlang Conference","Haskell Conference","Groovy Conference","Clojure Conference","F# Conference","RPG Conference","Scheme Conference","Smalltalk Conference","Tcl Conference","VHDL Conference","Verilog Conference","LabVIEW Conference","Pascal Conference","ActionScript Conference","Forth Conference","Transact-SQL Conference","Apex Conference","Rexx Conference","Awk Conference","Elixir Conference","Eiffel Conference"};
                        String[] description={"une conference sur un langage inconnu", "une conf sur un langage moyen", "une conf sur un langage trop bien", "Une conf comme ci comme ça", "une conférence sur le meilleur langage de programmation"};
